...
!(function (t, e) {
      ...
      return (
        ...
        (n._getRootElement = function (t) {
          var n = l.getSelectorFromElement(t),
            i = !1;
          return (
            n && (i = document.querySelector(n)), i || e(t).closest(".alert")[0]
          );
        }),
              ...
              if ("radio" === o.type)
                ...
                "checkbox" === o.type
                  ? "LABEL" === this._element.tagName &&
                    o.checked === this._element.classList.contains(y) &&
                    (t = !1)
                  : (t = !1);
              t &&
                ((o.checked = !this._element.classList.contains(y)),
  ...
  e(document)
    .on(S.CLICK_DATA_API, C, function (t) {
      var n = t.target;
      if (
        (e(n).hasClass("btn") || (n = e(n).closest(b)[0]),
    ...
    (e.fn[_] = D._jQueryInterface),
    (e.fn[_].Constructor = D),
      ...
      return (
        ...
        (n._addTouchEventListeners = function () {
          ...
          if (this._touchSupported) {
            var n = function (e) {
                t._pointerEvent && F[e.originalEvent.pointerType.toUpperCase()]
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (i || ((i = new t(this, o)), e(this).data(w, i)),
              "number" == typeof n)
            )
              i.to(n);
  ...
  var W = "collapse",
    ...
    Z = (function () {
      ...
      return (
        ...
        (n.show = function () {
          ...
          if (
            ...
            if ((e(this._element).trigger(r), !r.isDefaultPrevented())) {
              ...
              e(this._element)
                .one(l.TRANSITION_END, function () {
                  e(o._element).removeClass(X).addClass(z).addClass(Y),
                    (o._element.style[s] = ""),
                    o.setTransitioning(!1),
                    e(o._element).trigger(V.SHOWN);
                })
                ...
                for (var r = 0; r < o; r++) {
                  ...
                  null !== a &&
                    (e([].slice.call(document.querySelectorAll(a))).hasClass(
                      ...
                      e(s).addClass($).attr("aria-expanded", !1));
                }
        ...
        (n._getConfig = function (t) {
          return (
            ((t = s({}, Q, {}, t)).toggle = Boolean(t.toggle)),
            l.typeCheckConfig(W, t, B),
            t
          );
        }),
      ...
      return (
          ...
          if (
            ...
            e(o).trigger(i),
              i.isDefaultPrevented() ||
                ...
                e(this._menu).toggleClass(lt),
                e(o).toggleClass(lt).trigger(e.Event(st.HIDDEN, n)));
          }
        }),
        (i.dispose = function () {
        ...
        (i._getPlacement = function () {
          ...
          return (
            t.hasClass("dropup")
              ? ((n = "top-start"),
                e(this._menu).hasClass(ct) && (n = "top-end"))
              : t.hasClass("dropright")
              ? (n = "right-start")
              : t.hasClass("dropleft")
              ? (n = "left-start")
              : e(this._menu).hasClass(ct) && (n = "bottom-end"),
            n
          );
        }),
        ...
        (t._clearMenus = function (n) {
          if (!n || (3 !== n.which && ("keyup" !== n.type || 9 === n.which)))
            for (
              var i = [].slice.call(document.querySelectorAll(ht)),
                o = 0,
                r = i.length;
              o < r;
              o++
  ...
  e(document)
    .on(st.KEYDOWN_DATA_API, ht, gt._dataApiKeydownHandler)
    ...
    .on(st.CLICK_DATA_API, ht, function (t) {
      t.preventDefault(),
        t.stopPropagation(),
        gt._jQueryInterface.call(e(this), "toggle");
    })
    .on(st.CLICK_DATA_API, ".dropdown form", function (t) {
      t.stopPropagation();
    }),
    (e.fn[tt] = gt._jQueryInterface),
    (e.fn[tt].Constructor = gt),
      ...
      return (
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                this._setEscapeEvent(),
                this._setResizeEvent(),
                e(document).off(Ct.FOCUSIN),
                e(this._element).removeClass(St),
                e(this._element).off(Ct.CLICK_DISMISS),
                e(this._dialog).off(Ct.MOUSEDOWN_DISMISS),
                o)
              ) {
        ...
        (n._setEscapeEvent = function () {
          ...
          this._isShown && this._config.keyboard
            ? e(this._element).on(Ct.KEYDOWN_DISMISS, function (e) {
        ...
        (n._setResizeEvent = function () {
          var t = this;
          this._isShown
            ? e(window).on(Ct.RESIZE, function (e) {
          ...
          (this._element.style.display = "none"),
            ...
            this._showBackdrop(function () {
              e(document.body).removeClass(Tt),
                t._resetAdjustments(),
                t._resetScrollbar(),
                e(t._element).trigger(Ct.HIDDEN);
            });
        }),
        ...
        (n._showBackdrop = function (t) {
          ...
          if (this._isShown && this._config.backdrop) {
            if (
              ...
              e(this._element).on(Ct.CLICK_DISMISS, function (t) {
        ...
        (t._jQueryInterface = function (n, i) {
          return this.each(function () {
            ...
            if (
              (o || ((o = new t(this, r)), e(this).data(mt, o)),
              "string" == typeof n)
            ) {
              if (void 0 === o[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  e(document).on(Ct.CLICK_DATA_API, '[data-toggle="modal"]', function (t) {
    ...
    var a = e(n).one(Ct.SHOW, function (t) {
      t.isDefaultPrevented() ||
        a.one(Ct.HIDDEN, function () {
          e(i).is(":visible") && i.focus();
        });
    });
    At._jQueryInterface.call(e(n), r, this);
  }),
    (e.fn[_t] = At._jQueryInterface),
    (e.fn[_t].Constructor = At),
          ...
          s.forEach(function (t) {
            !(function (t, e) {
              ...
              if (-1 !== e.indexOf(n))
                return (
                  -1 === Nt.indexOf(n) ||
                  Boolean(t.nodeValue.match(Ot) || t.nodeValue.match(kt))
                );
              for (
  ...
  var Lt = "tooltip",
    ...
    $t = (function () {
      ...
      return (
        ...
        (i.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            s.setAttribute("id", a),
              ...
              this.setContent(),
              this.config.animation && e(s).addClass(Vt);
            var c =
            ...
            e(s).data(this.constructor.DATA_KEY, this),
              ...
              (this._popper = new n(this.element, s, this._getPopperConfig(h))),
              e(s).addClass(Yt),
              "ontouchstart" in document.documentElement &&
                e(document.body).children().on("mouseover", null, e.noop);
            var f = function () {
        ...
        (i.hide = function (t) {
          function n() {
            i._hoverState !== Kt && o.parentNode && o.parentNode.removeChild(o),
              i._cleanTipClass(),
        ...
        (i._enter = function (t, n) {
          ...
          (n = n || e(t.currentTarget).data(i)) ||
            ...
            t && (n._activeTrigger["focusin" === t.type ? Xt : zt] = !0),
            e(n.getTipElement()).hasClass(Yt) || n._hoverState === Kt
              ? (n._hoverState = Kt)
        ...
        (i._leave = function (t, n) {
          ...
          (n = n || e(t.currentTarget).data(i)) ||
            ...
            e(t.currentTarget).data(i, n)),
            t && (n._activeTrigger["focusout" === t.type ? Xt : zt] = !1),
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              ...
              (i || ((i = new t(this, o)), e(this).data(jt, i)),
              "string" == typeof n)
            ) {
              if (void 0 === i[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  (e.fn[Lt] = $t._jQueryInterface),
    (e.fn[Lt].Constructor = $t),
  ...
  var Gt = "popover",
    ...
    oe = s({}, $t.DefaultType, { content: "(string|element|function)" }),
    re = {
      HIDE: "hide" + Zt,
      HIDDEN: "hidden" + Zt,
      SHOW: "show" + Zt,
        ...
        (n._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (i || ((i = new n(this, o)), e(this).data(Jt, i)),
              "string" == typeof t)
            ) {
              if (void 0 === i[t])
    ...
    Ee = (function () {
      ...
      return (
        ...
        (n._getConfig = function (t) {
          if (
            "string" !=
            typeof (t = s({}, ue, {}, "object" == typeof t && t ? t : {}))
              .target
          ) {
            var n = e(t.target).attr("id");
            n || ((n = l.getUID(ae)), e(t.target).attr("id", n)),
              (t.target = "#" + n);
          }
        ...
        (n._activate = function (t) {
          ...
          i.hasClass("dropdown-item")
            ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(ge),
              i.addClass(ge))
            : (i.addClass(ge),
              i
                .parents(_e)
                .prev(me + ", " + pe)
                .addClass(ge),
              i.parents(_e).prev(".nav-item").children(me).addClass(ge)),
  ...
  e(window).on(de.LOAD_DATA_API, function () {
    ...
    (e.fn[ae] = Ee._jQueryInterface),
    (e.fn[ae].Constructor = Ee),
      ...
      return (
        (n.show = function () {
          ...
          if (
            ...
            var a = e.Event(be.HIDE, { relatedTarget: this._element }),
            ...
            if (
              ...
              var h = function () {
                var n = e.Event(be.HIDDEN, { relatedTarget: t._element }),
                  o = e.Event(be.SHOWN, { relatedTarget: i });
        ...
        (n._transitionComplete = function (t, n, i) {
          ...
          if (
            ...
            l.reflow(t),
            t.classList.contains(De) && t.classList.add(Ie),
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            var i = e(this),
              o = i.data(ye);
            if (
              (o || ((o = new t(this)), i.data(ye, o)), "string" == typeof n)
            ) {
              if (void 0 === o[n])
                throw new TypeError('No method named "' + n + '"');
              o[n]();
  ...
  e(document).on(
    ...
    (e.fn.tab = Ne._jQueryInterface),
    (e.fn.tab.Constructor = Ne),
      ...
      return (
        ...
        (n._getConfig = function (t) {
          return (
            ...
            l.typeCheckConfig(Oe, t, this.constructor.DefaultType),
            t
          );
        }),
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (o ||
                ((o = new t(this, "object" == typeof n && n)), i.data(ke, o)),
              "string" == typeof n)
            ) {
              if (void 0 === o[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  (e.fn[Oe] = We._jQueryInterface),
    (e.fn[Oe].Constructor = We),
          ...
          (i.prototype = {
            ...
            register: function (t, e, n) {
              ...
              return (
                ...
                a(e) || (e = [e]),
                s(e, function (e) {
                  u(e) && (e = { match: e }), i[t].addHandler(e);
                }),
                this
              );
            },
  ...
  !(function (e, t, a) {
    function n(e, t) {
      (this.$form = e),
        (this.$input = t),
        this.reset(),
        t.on("change paste", this.reset.bind(this));
    }
    var i = function () {
        return !1;
      },
    ...
    (n.prototype.reset = function () {
        ...
        return "keyup" === e
          ...
          ? ((r = e),
            this.haltedFormValidation ||
              (s.haltValidation(), (this.haltedFormValidation = !0)),
            null)
          : this.hasRun
          ? this.result
          : ((r = e),
      ...
      (n.prototype.done = function (e) {
        (this.result = e),
          ...
          this.haltedFormValidation &&
            (s.unHaltValidation(this.$form),
            "submit" === r
              ? this.$form.trigger("submit")
              : this.$input.trigger("validation.revalidate"));
      }),
      (n.loadInstance = function (e, t, a) {
        var i,
          r = t.get(0);
        return (
          r.asyncValidators || (r.asyncValidators = {}),
          r.asyncValidators[e]
            ? (i = r.asyncValidators[e])
            : ((i = new n(a, t)), (r.asyncValidators[e] = i)),
          i
        );
      }),
      (e.formUtils = e.extend(e.formUtils || {}, {
        asyncValidation: function (e, t, a) {
          return (
            ...
            n.loadInstance(e, t, a)
          );
        },
        addAsyncValidator: function (t) {
          var a = e.extend({}, t),
            i = a.validatorFunction;
          (a.async = !0),
            (a.validatorFunction = function (e, t, r, s, o, l) {
              return n.loadInstance(this.name, t, o).run(l, function (n) {
                i.apply(a, [n, e, t, r, s, o, l]);
              });
            }),
            this.addValidator(a);
        },
      })),
      e(t).bind("validatorsLoaded formValidationSetup", function (t, a) {
        a || (a = e("form")),
          a.find("[data-validation]").each(function () {
            var t = e(this);
            t.valAttr("async", !1),
              e.each(e.split(t.attr("data-validation")), function (a, n) {
                var i = e.formUtils.validators["validate_" + n];
    ...
    (function (e, t) {
      ...
      function a(t) {
        t &&
          ...
          (t.submitErrorMessageCallback = function (e, a) {
            t.errorMessageCustom(e, t.language.errorTitle, a, t);
          }));
      }
      function n(t) {
        if (
          t.errorMessagePosition &&
          "object" == typeof t.errorMessagePosition
        ) {
          e.formUtils.warn(
            "Deprecated use of config parameter errorMessagePosition, use config.submitErrorMessageCallback instead"
          );
          var a = t.errorMessagePosition;
      ...
      (e.fn.validateForm = function (t, a) {
        return (
          e.formUtils.warn(
        ...
        e(window)
          ...
          .on("validatorsLoaded formValidationSetup", function (t, a) {
            a || (a = e("form")),
              (function (t) {
                var a = t.find("[data-validation-if-checked]");
                a.length &&
                  e.formUtils.warn(
                  ...
                  a.on("beforeValidation", function () {
                    var a = e(this),
                      n = a.valAttr("if-checked"),
                      i = e('input[name="' + n + '"]', t),
                      r = i.is(":checked"),
                      s = (e.formUtils.getValue(i) || "").toString(),
                      o = a.valAttr("if-checked-value");
                    (!r || (o && o !== s)) && a.valAttr("skipped", !0);
                  });
              })(a);
          });
    })(e),
    (function (e) {
      "use strict";
      var t = {
        resolveErrorMessage: function (e, t, a, n, i) {
          var r =
              n.validationErrorMsgAttribute + "-" + a.replace("validate_", ""),
            s = e.attr(r);
          return (
            s ||
              (s = e.attr(n.validationErrorMsgAttribute)) ||
              (s =
                "function" != typeof t.errorMessageKey
                  ? i[t.errorMessageKey]
                  : i[t.errorMessageKey(n)]) ||
              (s = t.errorMessage),
            s
          );
        },
        getParentContainer: function (t) {
          if (t.valAttr("error-msg-container"))
            return e(t.valAttr("error-msg-container"));
          var a = t.parent();
          return (
            "checkbox" === t.attr("type") && t.closest(".checkbox").length
              ? (a = t.closest(".checkbox").parent())
              : "radio" === t.attr("type") &&
                t.closest(".radio").length &&
                (a = t.closest(".radio").parent()),
            a.closest(".input-group").length &&
              (a = a.closest(".input-group").parent()),
            a
          );
        },
        ...
        applyInputSuccessStyling: function (e, t) {
          e.addClass(t.successElementClass),
            this.getParentContainer(e).addClass(t.inputParentClassOnSuccess);
        },
        removeInputStylingAndMessage: function (e, a) {
          e.removeClass(a.successElementClass)
            .removeClass(a.errorElementClass)
            .css("border-color", "");
          var n = t.getParentContainer(e);
          if (
            (n
              .removeClass(a.inputParentClassOnError)
              .removeClass(a.inputParentClassOnSuccess),
            "function" == typeof a.inlineErrorMessageCallback)
          ) {
            var i = a.inlineErrorMessageCallback(e, !1, a);
            i && i.html("");
          } else n.find("." + a.errorMessageClass).remove();
        },
        removeAllMessagesAndStyling: function (a, n) {
          if ("function" == typeof n.submitErrorMessageCallback) {
            var i = n.submitErrorMessageCallback(a, !1, n);
            i && i.html("");
          } else a.find("." + n.errorMessageClass + ".alert").remove();
          a.find("." + n.errorElementClass + ",." + n.successElementClass).each(
            function () {
              t.removeInputStylingAndMessage(e(this), n);
            }
          );
        },
        setInlineMessage: function (t, a, n) {
          this.applyInputErrorStyling(t, n);
          var i,
            r = document.getElementById(t.attr("name") + "_err_msg"),
            s = !1,
            o = function (n) {
              e.formUtils.$win.trigger("validationErrorDisplay", [t, n]),
                n.html(a);
            },
            l = function () {
              var r = !1;
              s.find("." + n.errorMessageClass).each(function () {
          ...
          if (r)
            e.formUtils.warn("Using deprecated element reference " + r.id),
              (s = e(r)),
              l();
          else if ("function" == typeof n.inlineErrorMessageCallback) {
            if (!(s = n.inlineErrorMessageCallback(t, a, n))) return;
            l();
          } else {
            var d = this.getParentContainer(t);
            0 ===
              (i = d.find("." + n.errorMessageClass + ".help-block")).length &&
              (i = e("<span></span>")
                .addClass("help-block")
                .addClass(n.errorMessageClass)).appendTo(d),
              o(i);
          }
        },
        setMessageInTopOfForm: function (t, a, n, i) {
          var r =
          ...
          if (
            ...
            (s = n.submitErrorMessageCallback(t, a, n))
          ) {
            var o = {
    ...
    (function (e, t, a) {
      ...
      (e.fn.validateOnBlur = function (t, a) {
        var n = this,
          i = this.find("*[data-validation]");
        return (
          i.each(function () {
            var i = e(this);
            if (i.is("[type=radio]")) {
              var r = n.find('[type=radio][name="' + i.attr("name") + '"]');
              r.bind("blur.validation", function () {
                i.validateInputOnBlur(t, a, !0, "blur");
              }),
                a.validateCheckboxRadioOnClick &&
                  r.bind("click.validation", function () {
                    i.validateInputOnBlur(t, a, !0, "click");
                  });
            }
          }),
            ...
            return (
              ("FORM" === this[0].nodeName
                ...
                i &&
                  n
                    .unbind(i + ".validation")
                    .bind(i + ".validation", function (n) {
                      9 !== (n || {}).keyCode &&
                        e(this).validateInputOnBlur(t, a, !0, i);
                    });
              }),
              this
            );
        ...
        (e.fn.validate = function (t, a, n) {
          var i = e.extend({}, e.formUtils.LANG, n || {});
          this.each(function () {
            var n = e(this),
              r =
                (n.closest("form").get(0) || {}).validationConfig ||
                e.formUtils.defaultConfig();
            n.one("validation", function (e, a) {
              "function" == typeof t && t(a, this, e);
            }),
              n.validateInputOnBlur(i, e.extend({}, r, a || {}), !0);
          });
        }),
        (e.fn.willPostponeValidation = function () {
          return (
            ...
            !t.postponedValidation
          );
        }),
        (e.fn.validateInputOnBlur = function (a, n, i, r) {
          if (((e.formUtils.eventType = r), this.willPostponeValidation())) {
            var s = this,
              o = this.valAttr("postpone") || 200;
            return (
              (t.postponedValidation = function () {
                s.validateInputOnBlur(a, n, i, r), (t.postponedValidation = !1);
              }),
              setTimeout(function () {
          ...
          (a = e.extend({}, e.formUtils.LANG, a || {})),
            e.formUtils.dialogs.removeInputStylingAndMessage(this, n);
          var l = this,
            d = l.closest("form"),
            u = e.formUtils.validateInput(l, a, n, d, r),
            c = function () {
              l.validateInputOnBlur(a, n, !1, "blur.revalidated");
            };
          return (
            "blur" === r &&
              l
                .unbind("validation.revalidate", c)
                .one("validation.revalidate", c),
            i && l.removeKeyUpValidation(),
            u.shouldChangeDisplay &&
              (u.isValid
                ? e.formUtils.dialogs.applyInputSuccessStyling(l, n)
                : e.formUtils.dialogs.setInlineMessage(l, u.errorMsg, n)),
            !u.isValid && i && l.validateOnKeyUp(a, n),
            this
          );
        }),
        (e.fn.validateOnKeyUp = function (t, a) {
          return (
            this.each(function () {
              var n = e(this);
              n.valAttr("has-keyup-event") ||
                n
                  ...
                  .bind("keyup.validation", function (e) {
                    9 !== e.keyCode && n.validateInputOnBlur(t, a, !1, "keyup");
                  });
            }),
            this
          );
        ...
        (e.fn.isValid = function (t, a, n) {
          ...
          (a = e.extend({}, e.formUtils.defaultConfig(), a || {})),
            (t = e.extend({}, e.formUtils.LANG, t || {})),
            (n = !1 !== n),
            e.formUtils.errorDisplayPreventedWhenHalted &&
              (delete e.formUtils.errorDisplayPreventedWhenHalted, (n = !1));
          var r = function (t, i) {
              e.inArray(t, o) < 0 && o.push(t),
                l.push(i),
                i.valAttr("current-error", t),
                n && e.formUtils.dialogs.applyInputErrorStyling(i, a);
            },
            s = [],
            o = [],
            l = [],
            d = this;
          if (
            (n && e.formUtils.dialogs.removeAllMessagesAndStyling(d, a),
            d
                ...
                if (
                  !(function (t, n) {
                    return (
                      ...
                      "button" === n ||
                      "reset" === n ||
                      e.inArray(t, a.ignore || []) > -1
                    );
                  })(l, i) &&
                  (!o || e.inArray(l, s) < 0)
                ) {
                  o && s.push(l);
                  var u = e.formUtils.validateInput(n, t, a, d, "submit");
                  u.isValid
                    ? u.isValid &&
                      u.shouldChangeDisplay &&
                      (n.valAttr("current-error", !1),
                      e.formUtils.dialogs.applyInputSuccessStyling(n, a))
                    : r(u.errorMsg, n);
                }
              }),
            "function" == typeof a.onValidate)
          ) {
            var u = a.onValidate(d);
            e.isArray(u)
          ...
          return (
            ...
            l.length > 0 &&
              n &&
              ("top" === a.errorMessagePosition
                ? e.formUtils.dialogs.setMessageInTopOfForm(d, o, a, t)
                : e.each(l, function (t, n) {
                    e.formUtils.dialogs.setInlineMessage(
                      n,
                      n.valAttr("current-error"),
                      a
                    );
                  }),
              a.scrollToTopOnError &&
                e.formUtils.$win.scrollTop(d.offset().top - 20)),
            !n &&
              e.formUtils.haltValidation &&
              (e.formUtils.errorDisplayPreventedWhenHalted = !0),
        ...
        (e.fn.addSuggestions = function (t) {
          ...
          return (
            this.find("input").each(function () {
              var n = e(this);
              (a = e.split(n.attr("data-suggestions"))).length > 0 &&
                !n.hasClass("has-suggestions") &&
                (e.formUtils.suggest(n, a, t), n.addClass("has-suggestions"));
            }),
            this
          );
        });
    ...
    (function (e) {
      ...
      e.formUtils = e.extend(e.formUtils || {}, {
        ...
        loadModules: function (t, a, n) {
          if (e.formUtils.isLoadingModules)
            setTimeout(function () {
              e.formUtils.loadModules(t, a, n);
            }, 100);
          else {
            var i = function (t, a) {
              var i = e.split(t),
                ...
                s = function () {
                  0 === --r &&
                    ((e.formUtils.isLoadingModules = !1),
                    "function" == typeof n && n());
                };
              r > 0 && (e.formUtils.isLoadingModules = !0);
              var o = "?_=" + new Date().getTime(),
                l =
              ...
              e.each(i, function (t, n) {
                if (
                  0 === (n = e.trim(n)).length ||
                  e.formUtils.hasLoadedModule(n)
                )
                  s();
                else {
                  var i = a + n + (".js" === n.slice(-3) ? "" : ".js"),
                    r = document.createElement("SCRIPT");
                  "function" == typeof define && define.amd
                    ? require([i + (".dev.js" === i.slice(-7) ? o : "")], s)
                    : ((r.type = "text/javascript"),
                      (r.onload = s),
                      (r.src = i + (".dev.js" === i.slice(-7) ? o : "")),
                      (r.onerror = function () {
                        e.formUtils.warn(
                          "Unable to load form validation module " + i,
                          !0
                        ),
                          s();
                      }),
    ...
    (function (e) {
      ...
      (e.split = function (t, a, n) {
        ...
        if ("function" != typeof a) {
          ...
          var r = [];
          return (
            e.each(t.split(a || i), function (t, a) {
        ...
        t &&
          e.each(t.split(i), function (t, n) {
            if ((n = e.trim(n)).length) return a(n, t);
          });
      }),
        (e.validate = function (t) {
          var a = e.extend(e.formUtils.defaultConfig(), {
            form: "form",
            validateOnEvent: !1,
            validateOnBlur: !0,
          ...
          if (
            ((t = e.extend(a, t || {})),
            e(window).trigger("formValidationPluginInit", [t]),
            t.lang && "en" !== t.lang)
          ) {
            var n = "lang/" + t.lang + ".js";
            t.modules += t.modules.length ? "," + n : n;
          }
          e(t.form).each(function (a, n) {
            n.validationConfig = t;
            var i = e(n);
            i.trigger("formValidationSetup", [i, t]),
              i
                .find(".has-help-txt")
              ...
              i
                ...
                .unbind("blur.validation"),
              i
                .bind("submit.validation", function (a) {
                  var n = e(this),
                    i = function () {
                  ...
                  var r = n.isValid(t.language, t);
                  return e.formUtils.haltValidation
                    ? i()
                    : r && "function" == typeof t.onSuccess
                    ? !1 === t.onSuccess(n)
                      ? i()
                      : void 0
                    : r || "function" != typeof t.onError
                    ? !!r || i()
                    : (t.onError(n), i());
                })
              ...
              t.showHelpOnFocus && i.showHelpOnFocus(),
              t.addSuggestions && i.addSuggestions(),
              t.validateOnBlur &&
            ...
            "" !== t.modules &&
              e.formUtils.loadModules(t.modules, null, function () {
                ...
                var a = "string" == typeof t.form ? e(t.form) : t.form;
                e.formUtils.$win.trigger("validatorsLoaded", [a, t]);
              });
        });
    })(e),
    (function (e, t) {
      ...
      e.formUtils = e.extend(e.formUtils || {}, {
        ...
        validateInput: function (t, a, n, i, r) {
          (n = n || e.formUtils.defaultConfig()),
            (a = a || e.formUtils.LANG),
            i.length || (i = t.parent());
          var s = this.getValue(t);
          t.valAttr("skipped", !1)
            .one("beforeValidation", function () {
              (t.attr("disabled") ||
                (!t.is(":visible") && !n.validateHiddenInputs)) &&
                t.valAttr("skipped", 1);
            })
            .trigger("beforeValidation", [s, a, n]);
          var o = "true" === t.valAttr("optional"),
            l = !s && o,
            d = t.attr(n.validationRuleAttribute),
            u = !0,
            c = "",
            f = { isValid: !0, shouldChangeDisplay: !0, errorMsg: "" };
          if (!d || l || t.valAttr("skipped"))
            return (f.shouldChangeDisplay = n.addValidClassOnAll), f;
          var g = t.valAttr("ignore");
          return (
            g &&
              e.each(g.split(""), function (e, t) {
                s = s.replace(new RegExp("\\" + t, "g"), "");
              }),
            e.split(d, function (o) {
              ...
              if (
                ("validate_checkbox_group" === o &&
                  (t = i.find('[name="' + t.attr("name") + '"]:eq(0)')),
                ("keyup" !== r || l.validateOnKeyUp) &&
                  (u = l.validatorFunction(s, t, n, a, i, r)),
                !u)
              )
                return (
                  n.validateOnBlur && t.validateOnKeyUp(a, n),
                  (c = e.formUtils.dialogs.resolveErrorMessage(t, l, o, n, a)),
                  !1
                );
            }),
            !1 === u
              ? (t.trigger("validation", !1),
                (f.errorMsg = c),
                (f.isValid = !1),
                (f.shouldChangeDisplay = !0))
              : null === u
              ? (f.shouldChangeDisplay = !1)
              : (t.trigger("validation", !0), (f.shouldChangeDisplay = !0)),
            "function" == typeof n.onElementValidate &&
              null !== c &&
              n.onElementValidate(f.isValid, t, i, c),
            t.trigger("afterValidation", [f, r]),
            f
          );
        },
        parseDate: function (t, a, n) {
          var i,
            r,
            s,
            o,
            l = a.replace(/[a-zA-Z]/gi, "").substring(0, 1),
            d = "^",
            u = a.split(l || null);
          if (
            (e.each(u, function (e, t) {
          ...
          if (null === (i = t.match(new RegExp(d)))) return !1;
          var f = function (t, a, n) {
            for (var i = 0; i < a.length; i++)
              if (a[i].substring(0, 1) === t)
                return e.formUtils.parseDateInt(n[i + 1]);
            return -1;
          };
          return (
            (s = f("m", u, i)),
            ...
            !(
              ...
              !(
                (this.isShortMonth(s) && r > 30) ||
                (!this.isShortMonth(s) && r > 31) ||
                0 === r
              ) && [o, s, r]
          );
        },
        ...
        lengthRestriction: function (t, a) {
          var n = parseInt(a.text(), 10),
            ...
            r = function () {
              ...
              if (e > n) {
                var r = t.scrollTop();
                t.val(t.val().substring(0, n)), t.scrollTop(r);
              }
              (i = n - e) < 0 && (i = 0), a.text(i);
            };
          e(t)
        ...
        numericRangeCheck: function (t, a) {
          var n = e.split(a),
            i = parseInt(a.substr(3), 10);
          return (
            1 === n.length &&
              -1 === a.indexOf("min") &&
              -1 === a.indexOf("max") &&
              (n = [a, a]),
            2 === n.length && (t < parseInt(n[0], 10) || t > parseInt(n[1], 10))
              ? ["out", n[0], n[1]]
              : 0 === a.indexOf("min") && t < i
              ? ["min", i]
              : 0 === a.indexOf("max") && t > i
          ...
          return (
            t
              ...
              .bind("keyup.suggest", function () {
                var a = e(this),
                  n = [],
                  i = e.trim(a.val()).toLocaleLowerCase();
                if (i !== e.formUtils._previousTypedVal) {
                  e.formUtils._previousTypedVal = i;
                  var l = !1,
                    d = a.valAttr("suggestion-nr"),
                    u = e(".jquery-form-suggestion-" + d);
                  if ((u.scrollTop(0), "" !== i)) {
                    var c = i.length > 2;
                    e.each(a.data("suggestions"), function (e, t) {
                      var a = t.toLocaleLowerCase();
                      return a === i
                        ? (n.push("<strong>" + t + "</strong>"), (l = !0), !1)
                        : void (
                            (0 === a.indexOf(i) || (c && a.indexOf(i) > -1)) &&
                            n.push(
                              t.replace(
                                new RegExp(i, "gi"),
                                "<strong>$&</strong>"
                  ...
                  l || (0 === n.length && u.length > 0)
                    ? u.hide()
                    : n.length > 0 && 0 === u.length
                    ? ((u = e("<div></div>").css(r.css).appendTo("body")),
                      t.addClass("suggestions-" + d),
                      u
                        .attr("data-suggest-container", d)
                        .addClass("jquery-form-suggestions")
                        .addClass("jquery-form-suggestion-" + d))
                    : n.length > 0 && !u.is(":visible") && u.show(),
                    n.length > 0 &&
                      i.length !== n[0].length &&
                      (s(u, a),
                      u.html(""),
              ...
              .bind("keydown.validation", function (t) {
                ...
                if (13 === i && null !== e.formUtils._selectedSuggestion) {
                  if (
                    ...
                    (n = e(".jquery-form-suggestion-" + a)).length > 0)
                  ) {
                    var l = n
                      .find("div")
                      .eq(e.formUtils._selectedSuggestion)
                      .text();
                    s.val(l), s.trigger("change"), o(s), t.preventDefault();
                  }
                } else {
                  a = s.valAttr("suggestion-nr");
                  var d = (n = e(".jquery-form-suggestion-" + a)).children();
                  if (d.length > 0 && e.inArray(i, [38, 40]) > -1) {
                    38 === i
                      ? (null === e.formUtils._selectedSuggestion
                          ? (e.formUtils._selectedSuggestion = d.length - 1)
                          : e.formUtils._selectedSuggestion--,
                        e.formUtils._selectedSuggestion < 0 &&
                          (e.formUtils._selectedSuggestion = d.length - 1))
                      : 40 === i &&
                        (null === e.formUtils._selectedSuggestion
                          ? (e.formUtils._selectedSuggestion = 0)
                    ...
                    var u = n.innerHeight(),
                      ...
                      f =
                        ...
                        e.formUtils._selectedSuggestion;
                    return (
                      (f < c || f > c + u) && n.scrollTop(f),
                      d
                        .removeClass("active-suggestion")
                        .css("background", "none")
                        .eq(e.formUtils._selectedSuggestion)
                        .addClass("active-suggestion")
                        .css(r.activeSuggestionCSS),
                      t.preventDefault(),
                      !1
                    );
                  }
      ...
      e.formUtils.addValidator({
        ...
        validatorFunction: function (t) {
          ...
          if (n && i) {
            ...
            return (
              e.formUtils.validators.validate_domain.validatorFunction(a[1]) &&
              0 !== n.indexOf(".") &&
        ...
        e.formUtils.addValidator({
          name: "required",
          validatorFunction: function (t, a, n, i, r) {
            switch (a.attr("type")) {
              case "checkbox":
                return a.is(":checked");
              case "radio":
        ...
        e.formUtils.addValidator({
          name: "length",
          validatorFunction: function (t, a, n, i) {
            var r = a.valAttr("length"),
              s = a.attr("type");
            if (void 0 === r)
              return (
                alert(
            ...
            var o,
              l =
                "file" === s && void 0 !== a.get(0).files
                  ? a.get(0).files.length
                  : t.length,
              d = e.formUtils.numericRangeCheck(l, r);
            switch (d[0]) {
              case "out":
                (this.errorMessage = i.lengthBadStart + r + i.lengthBadEnd),
                  (o = !1);
                break;
              case "min":
                (this.errorMessage =
                  i.lengthTooShortStart + d[1] + i.lengthBadEnd),
                  (o = !1);
                break;
              case "max":
                (this.errorMessage =
                  i.lengthTooLongStart + d[1] + i.lengthBadEnd),
                  (o = !1);
                break;
              default:
                o = !0;
        ...
        e.formUtils.addValidator({
          ...
          validatorFunction: function (t) {
            if (
              ...
              return (
                n > -1 && (a = a.substr(0, n)),
                e.formUtils.validators.validate_domain.validatorFunction(a)
              );
            }
            return !1;
          },
        ...
        e.formUtils.addValidator({
          ...
          validatorFunction: function (e, t, a) {
            if ("" !== e) {
              ...
              if (
                (-1 === r.indexOf("number") && (r += ",number"),
                -1 === r.indexOf("negative") && 0 === e.indexOf("-"))
              )
                return !1;
              if (
                (r.indexOf("range") > -1 &&
          ...
          validatorFunction: function (t, a, n, i) {
            ...
            if (o) {
              ...
              u.indexOf(" ") > -1 &&
                ((d = !0),
                (u = u.replace(" ", "")),
                (u += i.andSpaces || e.formUtils.LANG.andSpaces)),
                i.badAlphaNumericAndExtraAndSpaces && i.badAlphaNumericAndExtra
                  ? (this.errorMessage = d
                      ? i.badAlphaNumericAndExtraAndSpaces + u
                      : i.badAlphaNumericAndExtra + u + i.badAlphaNumericExtra)
                  : (this.errorMessage =
                      i.badAlphaNumeric + i.badAlphaNumericExtra + u);
            } else (l = r + s), (this.errorMessage = i.badAlphaNumeric);
        ...
        e.formUtils.addValidator({
          ...
          validatorFunction: function (t, a, n) {
            var i = a.valAttr("format") || n.dateFormat || "yyyy-mm-dd",
              r = "false" === a.valAttr("require-leading-zero");
        ...
        e.formUtils.addValidator({
          ...
          validatorFunction: function (t, a, n, i, r) {
            var s = !0,
              o = a.attr("name"),
              l = e('input[type=checkbox][name^="' + o + '"]', r),
            ...
            var f = e.formUtils.numericRangeCheck(d, u);
            switch (f[0]) {
              case "out":
                (this.errorMessage =
                  i.groupCheckedRangeStart + u + i.groupCheckedEnd),
                  (s = !1);
                break;
              case "min":
                (this.errorMessage =
                  i.groupCheckedTooFewStart +
                  f[1] +
                  (i.groupCheckedTooFewEnd || i.groupCheckedEnd)),
                  (s = !1);
                break;
              case "max":
                (this.errorMessage =
                  i.groupCheckedTooManyStart +
                  f[1] +
                  (i.groupCheckedTooManyEnd || i.groupCheckedEnd)),
                  (s = !1);
                break;
              default:
                s = !0;
              ...
              var g = function () {
                l.unbind("click", g),
                  l
                    ...
                    .validateInputOnBlur(i, n, !1, "blur");
              };
              l.bind("click", g);
            }
            return s;
  ...
  function n(e, a) {
    (this.element = e),
      (this.options = t.extend(
        { onScrollStart: function () {}, onScrollEnd: function () {} },
        l,
        a
      )),
      (this._defaults = l),
    ...
    init: function () {
      ...
      if (
        ...
        (l =
          "" === n.navItemClassName
            ? t(i).find("a")
            : t(i).find("." + n.navItemClassName)),
        "auto" === n.navHeight)
      )
        s = t(i).height();
      else {
        if (isNaN(n.navHeight))
          throw new Error(
      ...
      (l.on("click", function (a) {
        var l, c;
        (l = this.href.split("#")[1]) !== o &&
          (a.preventDefault(), (c = t("#" + l).offset().top)),
          (r =
            t(this).data("scrolltime") !== o
              ? t(this).data("scrolltime")
              : n.scrollTime),
          n.mobileDropdown &&
            t(e).width() >= 0 &&
            t(e).width() <= n.mobileBreakpoint &&
            ("" === n.mobileDropdownClassName
              ? t(i).find("ul").slideUp("fast")
              : t("." + n.mobileDropdownClassName).slideUp("fast")),
          t("html, body")
            .stop()
            .animate({ scrollTop: c - s }, r)
            .promise()
            .done(function () {
    ...
    scrollspy: function (n, i, l) {
      ...
      for (
        s =
          ...
          a.body.scrollTop,
          r = e.innerHeight / 2 || a.documentElement.clientHeight / 2,
          m = i.length,
          c = 0;
        m > c;
        c++
        ...
        h !== o &&
          s > h.offset().top - r &&
          (n.activeParent
            ? (i.parent().removeClass(n.activeClassName),
              t(i[c]).parent().addClass(n.activeClassName))
            : (i.removeClass(n.activeClassName),
              t(i[c]).addClass(n.activeClassName)));
      }
    },
  }),
    (t.fn[i] = function (e) {
      return this.each(function () {
        t.data(this, "plugin_" + i) ||
          t.data(this, "plugin_" + i, new n(this, e));
      });
    });
...
!(function (e) {
  ...
  function n(t, n) {
    function D(t) {
      if (
        !(
          !0 === xe.data(P + "_intouch") ||
          e(t.target).closest(n.excludedElements, xe).length > 0
        )
      ) {
        ...
        if (
          ...
          return (
            ...
            Z(),
            K(0, c),
            !s || Se === n.fingers || n.fingers === T || C()
              ? ((Me = le()),
                2 == Se &&
                  (K(1, s[1]), (we = ve = re(Oe[0].start, Oe[1].start))),
                (n.swipeStatus || n.pinchStatus) && (u = j(a, be)))
              : (u = !1),
            !1 === u
              ? (j(a, (be = b)), u)
              : (n.hold &&
                  (Ae = setTimeout(
                    e.proxy(function () {
                      xe.trigger("hold", [a.target]),
                        n.hold && (u = n.hold.call(xe, a, a.target));
                    }, this),
                    n.longTapThreshold
                  )),
                J(!0),
    ...
    function L(t) {
      var p,
        ...
        h,
        g,
        d = t.originalEvent ? t.originalEvent : t;
      if (be !== x && be !== b && !B()) {
        var y,
          E = d.touches,
          S = $(E ? E[0] : d);
        if (
          ((Pe = le()),
          E && (Se = E.length),
          n.hold && clearTimeout(Ae),
          (be = m),
          2 == Se &&
            (0 == we
              ? (K(1, E[1]), (we = ve = re(Oe[0].start, Oe[1].start)))
              : ($(E[1]),
          ...
          if (
            ...
            (function (e, t) {
              if (!1 !== n.preventDefaultEvents)
                if (n.allowPageScroll === s) e.preventDefault();
                  ...
                  switch (t) {
                    case r:
                      ((n.swipeLeft && a) || (!a && n.allowPageScroll != w)) &&
                        e.preventDefault();
                      break;
                    case i:
                      ((n.swipeRight && a) || (!a && n.allowPageScroll != w)) &&
                        e.preventDefault();
                      break;
                    case l:
            ...
            })(t, (ge = ie(S.last, S.end))),
            (h = S.start),
            (g = S.end),
            (fe = Math.round(
              Math.sqrt(Math.pow(g.x - h.x, 2) + Math.pow(g.y - h.y, 2))
            )),
            (de = ne()),
            (function (e, t) {
              e != s && ((t = Math.max(t, ee(e))), (me[e].distance = t));
            })(he, fe),
            (y = j(d, be)),
            ...
            !n.triggerOnTouchEnd && O
              ? (be = U(m))
              : n.triggerOnTouchLeave && !O && (be = U(x)),
              (be != b && be != x) || j(d, be);
          }
        } else j(d, (be = b));
        !1 === y && j(d, (be = b));
    ...
    function R(e) {
      ...
      return (
        ...
        _() || !H()
          ? j(t, (be = b))
          : n.triggerOnTouchEnd || (!1 === n.triggerOnTouchEnd && be === m)
    ...
    function A(e) {
      var t = e.originalEvent ? e.originalEvent : e;
      n.triggerOnTouchLeave && j(t, (be = U(x)));
    }
    function I() {
      xe.off(ae, D),
        xe.off(pe, k),
    ...
    function U(e) {
      ...
      return (
        !r || l
          ? (t = b)
          : !i || e != m || (n.triggerOnTouchEnd && !n.triggerOnTouchLeave)
          ? !i && e == x && n.triggerOnTouchLeave && (t = b)
          : (t = x),
        t
      );
    }
    function j(e, t) {
      ...
      return (
        ...
        G() && z() && !1 !== r
          ? (r = N(e, t, g))
          : de > n.longTapThreshold && y > fe && n.longTap && !1 !== r
          ? (r = N(e, t, d))
          : !((1 !== Se && S) || !(isNaN(fe) || fe < n.threshold) || !W()) &&
            !1 !== r &&
            (r = N(e, t, h)),
        t === b && k(),
        t === x && ((i && i.length) || k()),
      ...
      if (c == p) {
        ...
        if (s == x && F()) {
          if (
            (clearTimeout(ke),
            clearTimeout(Ae),
            xe.trigger("swipe", [he, fe, de, Se, Oe, ge]),
            n.swipe && !1 === (w = n.swipe.call(xe, t, he, fe, de, Se, Oe, ge)))
          )
            return !1;
          switch (he) {
            case r:
              xe.trigger("swipeLeft", [he, fe, de, Se, Oe, ge]),
                n.swipeLeft &&
                  (w = n.swipeLeft.call(xe, t, he, fe, de, Se, Oe, ge));
              break;
            case i:
              xe.trigger("swipeRight", [he, fe, de, Se, Oe, ge]),
                n.swipeRight &&
                  (w = n.swipeRight.call(xe, t, he, fe, de, Se, Oe, ge));
              break;
            case l:
              xe.trigger("swipeUp", [he, fe, de, Se, Oe, ge]),
                n.swipeUp &&
                  (w = n.swipeUp.call(xe, t, he, fe, de, Se, Oe, ge));
              break;
            case o:
              xe.trigger("swipeDown", [he, fe, de, Se, Oe, ge]),
                n.swipeDown &&
                  (w = n.swipeDown.call(xe, t, he, fe, de, Se, Oe, ge));
          }
        }
      }
      if (c == f) {
        if (
          (xe.trigger("pinchStatus", [
            s,
            Ee || null,
            ye || 0,
            de || 0,
        ...
        if (s == x && Q())
          switch (Ee) {
            case a:
              xe.trigger("pinchIn", [Ee || null, ye || 0, de || 0, Se, Te, Oe]),
                n.pinchIn &&
                  (w = n.pinchIn.call(
                    xe,
                    t,
      ...
      return (
        c == h
                ...
                (ke = setTimeout(
                  e.proxy(function () {
                    (Re = null),
                      ...
                      n.tap && (w = n.tap.call(xe, t, t.target));
                  }, this),
          ...
          ? (s !== b && s !== x) ||
            ...
            n.doubleTap && (w = n.doubleTap.call(xe, t, t.target)))
          : c == d &&
            ((s !== b && s !== x) ||
              (clearTimeout(ke),
              (Re = null),
              xe.trigger("longtap", [t.target]),
              n.longTap && (w = n.longTap.call(xe, t, t.target)))),
        w
      );
    }
    function H() {
    ...
    function _() {
      ...
      return (
        null !== n.cancelThreshold &&
          null !== he &&
          (e = ee(he) - fe >= n.cancelThreshold),
        e
      );
    }
    function q() {
      return !n.maxTimeThreshold || !(de >= n.maxTimeThreshold);
    }
    function Q() {
      var e = Y(),
        t = V(),
        r = null === n.pinchThreshold || ye >= n.pinchThreshold;
      return e && t && r;
    }
    function C() {
    ...
    function Y() {
      return Se === n.fingers || n.fingers === T || !S;
    }
    function V() {
      return 0 !== Oe[0].end.x;
    }
    ...
    function G() {
      if (null == Re) return !1;
      var e = le();
      return z() && e - Re <= n.doubleTapThreshold;
    }
    function Z() {
      (De = 0), (Le = 0);
    }
    function B() {
      var e = !1;
      De && le() - De <= n.fingerReleaseThreshold && (e = !0);
      return e;
    }
    function J(e) {
      xe &&
        (!0 === e
          ? (xe.on(ue, L), xe.on(se, R), ce && xe.on(ce, A))
          : (xe.off(ue, L, !1), xe.off(se, R, !1), ce && xe.off(ce, A, !1)),
        xe.data(P + "_intouch", !0 === e));
    }
    function K(e, t) {
      var n = {
        start: { x: 0, y: 0 },
    ...
    n = e.extend({}, n);
    var oe = S || M || !n.fallbackToMouseEvents,
      ae = oe
        ? M
          ? O
            ? "MSPointerDown"
      ...
      Ae = null;
    try {
      xe.on(ae, D), xe.on(pe, k);
    } catch (t) {
      e.error("events not supported " + ae + "," + pe + " on jQuery.swipe");
    }
    (this.enable = function () {
      return this.disable(), xe.on(ae, D), xe.on(pe, k), xe;
    }),
      (this.disable = function () {
        return I(), xe;
      }),
      (this.destroy = function () {
        I(), xe.data(P, null), (xe = null);
      }),
    ...
    var I,
      ...
      W =
        ...
        function (t) {
          ...
          return (
            k(
              (t + " " + ["webkit", "moz", "ms", "o"].join(e + " ") + e).split(
                " "
              ),
              function (e) {
...
(M.anime = (function () {
  ...
  function f(t, i) {
    var n = u(i);
    if (((n = -1 < i.indexOf("scale") ? 1 : 0 + n), !(t = t.style.transform)))
      return n;
  ...
  function C(t) {
    return e((t = t ? i(H.arr(t) ? t.map(n) : n(t)) : []), function (t, e, i) {
      return i.indexOf(t) === e;
    });
  }
  function E(t) {
  ...
  function L(t, e) {
    ...
    return t.tweens.map(function (n) {
      var s = (n = O(n, e)).value,
        o = m(e.target, t.name),
        a = i ? i.to.original : o,
        r = ((a = H.arr(s) ? s[0] : a), g(H.arr(s) ? s[1] : s, a));
      return (
        (o = d(r) || d(a) || d(o)),
        (n.from = w(a, o)),
        (n.to = w(r, o)),
      ...
      return function (e, i, n, s) {
        if (0 <= e && 1 >= e && 0 <= n && 1 >= n) {
          ...
          return function (a) {
            ...
            --l, (l = r + ((a - o[l]) / (o[l + 1] - o[l])) * 0.1);
            var h =
              3 * (1 - 3 * n + 3 * e) * l * l + 2 * (3 * n - 6 * e) * l + 3 * e;
            if (0.001 <= h) {
              for (
                r = 0;
                4 > r &&
...
(window.Modernizr = (function (e, t, n) {
  ...
  function c(e, t, r) {
    for (var a in e) {
      var i = t[e[a]];
      if (i !== n)
        return !1 === r ? e[a] : o(i, "function") ? i.bind(r || t) : i;
    }
    return !1;
  }
  function s(e, t, n) {
  ...
  var l,
    ...
    N = function (e, n, r, o) {
      ...
      if (parseInt(r, 10))
        for (; r--; )
          ((c = t.createElement("div")).id = o ? o[r] : p + (r + 1)),
            l.appendChild(c);
      return (
        ...
        u
          ...
          : (d.parentNode.removeChild(d), (f.style.overflow = s)),
        !!i
      );
    },
    $ = (function () {
  ...
  (C.rgba = function () {
    return (
      r("background-color:rgba(150,255,150,.5)"), a(h.backgroundColor, "rgba")
    );
  }),
  (C.hsla = function () {
    return (
  ...
  (C.fontface = function () {
    var e;
    return (
      N('@font-face {font-family:"font";src:url("https://")}', function (n, r) {
  ...
  (C.inlinesvg = function () {
    var e = t.createElement("div");
    return (
      (e.innerHTML = "<svg/>"), (e.firstChild && e.firstChild.namespaceURI) == S
    );
  }),
  (C.smil = function () {
    return (
      !!t.createElementNS &&
      /SVGAnimate/.test(v.call(t.createElementNS(S, "animate")))
    );
  }),
  (C.svgclippaths = function () {
    return (
      !!t.createElementNS &&
      /SVGClipPath/.test(v.call(t.createElementNS(S, "clipPath")))
    );
  }),
  C))
    u(C, P) &&
      ((l = P.toLowerCase()), (d[l] = C[P]()), j.push((d[l] ? "" : "no-") + l));
  return (
    d.input ||
      ((d.input = (function (n) {
        for (var r = 0, o = n.length; r < o; r++) k[n[r]] = n[r] in g;
        return (
          k.list &&
    ...
    (f.className =
      f.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + " js " + j.join(" ")),
    d
  );
})(this, this.document)),
  (function (e, t, n) {
    ...
    function s(e, n, r, o, a, s, l) {
      ...
      1 === k[n] && ((g = 1), (k[n] = [])),
        ...
        "img" != e &&
          (g || 2 === k[n]
            ? (E.insertBefore(d, x ? null : h), m(u, l))
            : k[n].push(d));
    }
    ...
    (f = function (e) {
      ...
      (e.yepnope.injectCss = function (e, n, r, o, i, s) {
        var l;
        (o = t.createElement("link")), (n = s ? c : n || a);
        for (l in ((o.href = e),
        (o.rel = "stylesheet"),
        (o.type = "text/css"),
        r))
      ...
      var c,
        ...
        b = function () {
          ...
          return (
            ...
            n || ((n = a = u.createElement("body")).style.background = "none"),
            (d.style.fontSize = "100%"),
            (n.style.fontSize = "100%"),
            n.appendChild(t),
            a && d.insertBefore(n, d.firstChild),
            (e = t.offsetWidth),
            a ? d.removeChild(n) : n.removeChild(t),
            (d.style.fontSize = r),
        ...
        x = function (t) {
          var n = "clientWidth",
            r = d[n],
            o = ("CSS1Compat" === u.compatMode && r) || u.body[n] || r,
            a = {},
            i = v[v.length - 1],
            h = new Date().getTime();
          if (t && c && 30 > h - c)
            return e.clearTimeout(s), void (s = e.setTimeout(x, 30));
          for (var y in ((c = h), f))
            if (f.hasOwnProperty(y)) {
              var E = f[y],
                ...
                C = null === w,
                T = null === S;
              w && (w = parseFloat(w) * (w.indexOf("em") > -1 ? l || b() : 1)),
                S &&
                  (S = parseFloat(S) * (S.indexOf("em") > -1 ? l || b() : 1)),
                (E.hasquery &&
                  ((C && T) || !(C || o >= w) || !(T || S >= o))) ||
                  (a[E.media] || (a[E.media] = []),
                  a[E.media].push(p[E.rules]));
            }
          for (var k in m)
            m.hasOwnProperty(k) &&
              m[k] &&
              m[k].parentNode === g &&
              g.removeChild(m[k]);
          for (var j in ((m.length = 0), a))
            if (a.hasOwnProperty(j)) {
              var M = u.createElement("style"),
                N = a[j].join("\n");
              (M.type = "text/css"),
                (M.media = j),
                g.insertBefore(M, i.nextSibling),
                M.styleSheet
                  ? (M.styleSheet.cssText = N)
                  : M.appendChild(u.createTextNode(N)),
                m.push(M);
            }
        },
        E = function (e, t, r) {
          ...
          for (var l = 0; a > l; l++) {
            ...
            s
              ? ((u = r), p.push(c(e)))
              : ((u = o[l].match(n.regex.findStyles) && RegExp.$1),
                p.push(RegExp.$2 && c(RegExp.$2))),
              (h = (m = u.split(",")).length);
            for (var g = 0; h > g; g++)
              (d = m[g]),
                i(d) ||
                  f.push({
                    media:
                      (d.split("(")[0].match(n.regex.only) && RegExp.$2) ||
                      "all",
                    rules: p.length - 1,
  ...
  (u = (function (t) {
    ...
    (_ = function (t) {
      ...
      if (!P.length && j.ajax) {
        ...
        if (((e = t.toUpperCase()), Y.call(j.ajax.trackMethods, e) >= 0))
          return !0;
      }
      return !1;
    }),
...
!(function (e, a) {
  ...
  !(function (e, a) {
    ...
    e.formUtils.registerLoadedModule("security"),
      e.formUtils.addValidator({
        name: "spamcheck",
        validatorFunction: function (e, a) {
          return a.valAttr("captcha") === e;
        },
        errorMessage: "",
      ...
      e.formUtils.addValidator({
        name: "confirmation",
        validatorFunction: function (a, t, r, n, i) {
          var o,
            d = t.valAttr("confirm") || t.attr("name") + "_confirmation",
            l = i.find('[name="' + d + '"]');
          if (!l.length)
            return (
              e.formUtils.warn(
          ...
          if (
            ((o = l.val()), r.validateOnBlur && !l[0].hasValidationCallback)
          ) {
            ...
            l.on("keyup", s),
              i.one("formValidationSetup", function () {
                (l[0].hasValidationCallback = !1), l.off("keyup", s);
              });
          }
          return a === o;
        },
    ...
    e.formUtils.addValidator({
      name: "creditcard",
      validatorFunction: function (a, i) {
        var o = e.split(i.valAttr("allowing") || "");
        if (
          ((n = e.inArray("amex", o) > -1),
          (r = n && 1 === o.length),
          o.length > 0)
        ) {
          var d = !1;
          if (
            (e.each(o, function (r, n) {
              if (n in t) {
                if (a.length >= t[n][0] && a.length <= t[n][1])
                  return (d = !0), !1;
              } else e.formUtils.warn('Use of unknown credit card "' + n + '"', !0);
            }),
            !d)
          )
            return !1;
        ...
        var l = 0;
        return (
          e.each(a.split("").reverse(), function (e, a) {
            (a = parseInt(a, 10)),
              e % 2 == 0 ? (l += a) : (l += (a *= 2) < 10 ? a : a - 9);
          }),
          l % 10 == 0
        );
      },
      ...
      e.formUtils.addValidator({
        name: "strength",
        validatorFunction: function (a, t) {
          var r = t.valAttr("strength") || 2;
          return (
            r && r > 3 && (r = 3),
            e.formUtils.validators.validate_strength.calculatePasswordStrength(
              a
            ) >= r
          );
        },
          ...
          var a = 0,
            t = function (e, a) {
              for (var t = "", r = 0; r < a.length; r++) {
                for (var n = !0, i = 0; i < e && i + r + e < a.length; i++)
                  n = n && a.charAt(i + r) === a.charAt(i + r + e);
                i < e && (n = !1),
                  n ? ((r += e - 1), (n = !1)) : (t += a.charAt(r));
              }
              return t;
            };
          return (
            (a += 4 * e.length),
            (a += 1 * (t(1, e).length - e.length)),
            (a += 1 * (t(2, e).length - e.length)),
            (a += 1 * (t(3, e).length - e.length)),
            (a += 1 * (t(4, e).length - e.length)),
            e.match(/(.*[0-9].*[0-9].*[0-9])/) && (a += 5),
            e.match(/(.*[!,@,#,$,%,^,&,*,?,_,~].*[!,@,#,$,%,^,&,*,?,_,~])/) &&
              (a += 5),
            e.match(/([a-z].*[A-Z])|([A-Z].*[a-z])/) && (a += 10),
            e.match(/([a-zA-Z])/) && e.match(/([0-9])/) && (a += 15),
            e.match(/([!,@,#,$,%,^,&,*,?,_,~])/) &&
              e.match(/([0-9])/) &&
              (a += 15),
            e.match(/([!,@,#,$,%,^,&,*,?,_,~])/) &&
              e.match(/([a-zA-Z])/) &&
              (a += 15),
            (e.match(/^\w+$/) || e.match(/^\d+$/)) && (a -= 10),
            a < 0 && (a = 0),
            a > 100 && (a = 100),
            a < 20 ? 0 : a < 40 ? 1 : a <= 60 ? 2 : 3
          );
        },
        strengthDisplay: function (a, t) {
          var r = {
            fontSize: "12pt",
            padding: "4px",
            bad: "Very bad",
          ...
          t && e.extend(r, t),
            a.bind("keyup", function () {
              var a = e(this).val(),
                t = void 0 === r.parent ? e(this).parent() : e(r.parent),
                n = t.find(".strength-meter"),
                i =
                  e.formUtils.validators.validate_strength.calculatePasswordStrength(
                    a
                  ),
                ...
                d = r.bad;
              0 === n.length &&
                (n = e("<span></span>")).addClass("strength-meter").appendTo(t),
                a ? n.show() : n.hide(),
                1 === i
                  ? (d = r.weak)
                  : 2 === i
    ...
    var i = function (a, t, r, n, i) {
      var o = t.valAttr("req-params") || t.data("validation-req-params") || {},
        d = t.valAttr("param-name") || t.attr("name"),
        l = function (e, a) {
          a(e);
        };
      if (!d)
      ...
      o || (o = {}),
        "string" == typeof o && (o = e.parseJSON(o)),
        (o[d] = r),
        e.ajax({
          url: a,
          type: "POST",
    ...
    e.formUtils.addAsyncValidator({
      name: "server",
      validatorFunction: function (e, a, t, r, n, o) {
        var d = t.valAttr("url") || r.backendUrl || document.location.href;
        o.addClass("validating-server-side"),
          t.addClass("validating-server-side"),
          i(d, t, a, 0, function (a) {
            o.removeClass("validating-server-side"),
              t.removeClass("validating-server-side"),
              a.message && t.attr(r.validationErrorMsgAttribute, a.message),
              e(a.valid);
          });
      },
      errorMessage: "",
      ...
      e.formUtils.addValidator({
        name: "letternumeric",
        validatorFunction: function (a, t, r, n) {
          var i =
          ...
          if (d) {
            ...
            s.indexOf(" ") > -1 &&
              ((s = s.replace(" ", "")),
              (s += n.andSpaces || e.formUtils.LANG.andSpaces)),
              (this.errorMessage =
                n.badAlphaNumeric + n.badAlphaNumericExtra + s);
          } else (l = i + o), (this.errorMessage = n.badAlphaNumeric);
          return new RegExp(l).test(a);
        },
        errorMessage: "",
      ...
      e.formUtils.addValidator({
        name: "complexity",
        validatorFunction: function (a, t, r, n) {
          var i = t.valAttr("require-uc-letter") || "0",
            o = t.valAttr("require-lc-letter") || "0",
            d = t.valAttr("require-special-char") || "0",
            l = t.valAttr("require-numeral") || "0",
            s = t.valAttr("require-length") || "0",
            c = {
              "uc-letter": {
                pattern: "^(?=(?:.*[A-Z]){" + i + ",}).+",
                numRequired: i,
                dialogEnd: n.passwordComplexityUppercaseInfo,
              },
              "lc-letter": {
                pattern: "^(?=(?:.*[a-z]){" + o + ",}).+",
                numRequired: o,
                dialogEnd: n.passwordComplexityLowercaseInfo,
              },
              "special-char": {
                pattern:
                  "^(?=(?:.*(_|[!\"#$%&'()*+\\\\,-./:;<=>?@[\\]^_`{|}~])){" +
                  ...
                  ",}).+",
                numRequired: d,
                dialogEnd: n.passwordComplexitySpecialCharsInfo,
              },
              numeral: {
                pattern: "^(?=(?:.*\\d){" + l + ",}).+",
                numRequired: l,
                dialogEnd: n.passwordComplexityNumericCharsInfo,
              },
              length: {
                callback: function (e) {
                  return e.length >= s;
                ...
                numRequired: s,
                dialogEnd: n.lengthBadEnd,
              },
            },
            h = "";
          return (
            e.each(c, function (e, r) {
              var i = parseInt(r.numRequired, 10);
              if (i) {
                var o = new RegExp(r.pattern);
                (r.callback ? r.callback(a) : o.test(a))
                  ? t.trigger("complexityRequirementValidation", [!0, e])
                  : ("" === h && (h = n.passwordComplexityStart),
                    (h += n.passwordComplexitySeparator + i + r.dialogEnd),
                    t.trigger("complexityRequirementValidation", [!1, e]));
              }
            }),
            !h || ((this.errorMessage = h + n.passwordComplexityEnd), !1)
          );
        },
        errorMessage: "",
        errorMessageKey: "",
      ...
      e.formUtils.addValidator({
        ...
        validatorFunction: function (e, a) {
          return (
            "" !== grecaptcha.getResponse(a.valAttr("recaptcha-widget-id"))
          );
        },
        errorMessage: "",
        errorMessageKey: "badreCaptcha",
      }),
      (e.fn.displayPasswordStrength = function (a) {
        return (
          new e.formUtils.validators.validate_strength.strengthDisplay(this, a),
          this
        );
      });
    (a.reCaptchaLoaded = function (a) {
      (a && "object" == typeof a && a.length) || (a = e("form")),
        a.each(function () {
          var a = e(this),
            t = a.get(0).validationConfig || a.context.validationConfig || !1;
          t &&
            e('[data-validation~="recaptcha"]', a).each(function () {
              var r = e(this),
                n = document.createElement("DIV"),
                i = t.reCaptchaSiteKey || r.valAttr("recaptcha-sitekey"),
                o = t.reCaptchaTheme || r.valAttr("recaptcha-theme") || "light",
                d = t.reCaptchaSize || r.valAttr("recaptcha-size") || "normal",
                l = t.reCaptchaType || r.valAttr("recaptcha-type") || "image";
              if (!i) throw new Error("Google reCaptcha site key is required.");
              var s = grecaptcha.render(n, {
                sitekey: i,
                theme: o,
                size: d,
                type: l,
                callback: function (e) {
                  a.find('[data-validation~="recaptcha"]').trigger(
                    "validation",
                    e && "" !== e
                  );
                },
              ...
              r.valAttr("recaptcha-widget-id", s)
                .hide()
      ...
      e(a).on("validatorsLoaded formValidationSetup", function (a, t, r) {
        if (
          (t || (t = e("form")),
          "undefined" != typeof grecaptcha && !e.formUtils.hasLoadedGrecaptcha)
        )
          throw new Error(
            "reCaptcha API can not be loaded by hand, delete reCaptcha API snippet."
          );
        if (
          !e.formUtils.hasLoadedGrecaptcha &&
          e('[data-validation~="recaptcha"]', t).length
        ) {
...
$("#header").length > 0 && (sticky = $header[0].offsetTop + 80);
var progressOffset = 0,
  $progress = $("#progress").offset();
function playProgress() {
  window.pageYOffset > progressOffset && $("#progress").removeClass("zero");
}
$("#progress").length > 0 && (progressOffset = $progress.top - 200),
  $(document).ready(function () {
    setTimeout(function () {
      window.onscroll = function () {
        playProgress(), fixedNav(), fixedFabNav();
      };
    }, 500),
      $("#preloader").delay(1e3).fadeOut("fast"),
      $(".transition-page")
        .addClass("page-fadeUp-transition-enter")
        .delay(1e3)
        .queue(function () {
          $(this)
    ...
    var e = document.querySelector(".collapsible.expandable");
    M.Collapsible.init(e, { accordion: !1 });
    $(".select").formSelect(), $(".tooltipped").tooltip();
  });
var $photoCarousel = $("#about_photo_carousel"),
  $teamCarousel = $("#about_team_carousel"),
  $teamPrev = $("#team_prev"),
  $teamNext = $("#team_next");
$(document).ready(function () {
  $photoCarousel.slick({
...
function onPlayerStateChange(e) {
  e.data != YT.PlayerState.PLAYING ||
    ...
    (setTimeout(stopVideo, 6e3), (done = !0));
}
function playVideo() {
  player.playVideo();
}
...
$(function () {
  $carousel.slick({
    ...
    autoplay: !1,
    cssEase: "ease-out",
    responsive: [{ breakpoint: 960, settings: { dots: !0, fade: !0 } }],
  });
}),
  ...
  $carousel.on("afterChange", function (e, t, a) {
    var o = a;
    $carouselNav.removeClass("active"),
      $("#banner_nav > a[data-slide=" + o + "]").addClass("active");
  });
var tag = document.createElement("script");
tag.src = "https://www.youtube.com/iframe_api";
var firstScriptTag = document.getElementsByTagName("script")[0];
  ...
  $(function () {
    ...
    function o() {
      $("iframe#video_blog_iframe").remove(),
        $("#video_modal .text-center").append(
          "<div id='video_blog_iframe'></div>"
        );
    }
    $(".modal").modal({
      onOpenEnd: function (t, o) {
        new YT.Player("video_blog_iframe", {
          height: "360",
          width: "640",
          videoId: "6p0VM-yUpGk",
          playerVars: { autoplay: 1, rel: 0 },
          events: { onReady: e, onStateChange: a },
        });
      },
      onCloseEnd: function () {
        o();
...
function sendChat() {
  ...
  $chatContainer.append(
    '<li class="justify-content-end"><span class="talk">' + e + "</span></li>"
  ),
    $chatField.val("");
  var t = document.getElementById("chat-container");
  setTimeout(function () {
  ...
  (function ($) {
    function numberRoller(e) {
      var t = $(".roller-title-number-" + e).attr("data-min"),
        a = $(".roller-title-number-" + e).attr("data-max"),
        o = $(".roller-title-number-" + e).attr("data-delay");
      numberRoll(
        e,
        t,
        a,
      ...
      ($.fn.scrollzip = function (e) {
        ...
        return this.each(function (e, a) {
          return (
            ...
            $.isFunction(t.showFunction) &&
              $("#scrollzipPoint").length > 0 &&
              !$(this).hasClass("isShown") &&
              $(window).outerHeight() +
                $("#scrollzipPoint").offset().top -
                t.showShift >
                $(this).offset().top +
                  (t.wholeVisible ? $(this).outerHeight() : 0) &&
              $("#scrollzipPoint").offset().top +
                (t.wholeVisible ? $(this).outerHeight() : 0) <
                $(this).outerHeight() + $(this).offset().top - t.showShift &&
              ($(this).addClass("isShown"), t.showFunction.call(this)),
            $.isFunction(t.hideFunction) &&
              $(this).hasClass("isShown") &&
              ($(window).outerHeight() +
                $("#scrollzipPoint").offset().top -
                t.hideShift <
                ...
                $("#scrollzipPoint").offset().top +
                  (t.wholeVisible ? $(this).outerHeight() : 0) >
                  $(this).outerHeight() + $(this).offset().top - t.hideShift) &&
              ($(this).removeClass("isShown"), t.hideFunction.call(this)),
            this
          );
        });
      });
...
function removeArray(e) {
  for (var t, a, o = arguments, i = o.length; i > 1 && e.length; )
    for (t = o[--i]; -1 !== (a = e.indexOf(t)); ) e.splice(a, 1);
  return e;
}
$bookOpen1.click(function () {
  ...
  $("#switch_view button").click(function () {
    $("#switch_view button").removeClass("active"),
      ...
      "grid" === $(this).data("value")
        ? ($("#product_result > .col")
            .addClass("col-lg-4")
            .removeClass("col-sm-12"),
          $("#product_result .product-card")
            .addClass("portrait")
...
var checkAll = [
  ...
  sortVal = { sortBy: "price", sortfrom: -1, sortTo: 1 };
function intersection(e, t) {
  return e.filter(function (e) {
    return t.includes(e);
  });
}
function checkFilter(e, t) {
  return "all" === t || e === t;
}
function filterResult() {
  return $("#product_result")
    ...
    .filter(function (e) {
      return (
        checkFilter(e.category, filterVal.category) &&
        checkFilter(e.radio, filterVal.radio) &&
        e.price >= filterVal.range.from &&
        e.price <= filterVal.range.to &&
        e.rating >= filterVal.rating &&
        filterVal.check.indexOf(e.check) > -1 &&
        intersection(filterVal.tags, e.tag).length > 0
      );
    })
    .sort(function (e, t) {
      return e[sortVal.sortBy] > t[sortVal.sortBy]
        ? sortVal.sortFrom
        : sortVal.sortTo;
    });
}
...
function renderResult() {
  var e = filterResult();
  for (
    $("#result_length").text(e.length), $("#product_result").html(""), i = 0;
    i < e.length;
    i++
  )
...
$("#sort_by").change(function (e) {
  switch (e.target.value) {
    case "title-asc":
      (sortVal.sortBy = "title"), (sortVal.sortFrom = 1), (sortVal.sortTo = -1);
      break;
    case "title-desc":
      (sortVal.sortBy = "title"), (sortVal.sortFrom = -1), (sortVal.sortTo = 1);
      break;
    case "price-asc":
      (sortVal.sortBy = "price"), (sortVal.sortFrom = -1), (sortVal.sortTo = 1);
      break;
    default:
      (sortVal.sortBy = "price"), (sortVal.sortFrom = 1), (sortVal.sortTo = -1);
  }
  ...
  $('.filter_check li input[type="checkbox"]').click(function () {
    ...
    $(".filter_check li").removeClass("active"),
      $(this).parents(".collection-item").addClass("active"),
      $(this).is(":checked")
        ? filterVal.check.push(e)
        : removeArray(filterVal.check, e),
      renderResult();
  }),
  $(".select_all_categories").click(function () {
    (filterVal.check = checkAll),
      $('.filter_check input[type="checkbox"]').prop("checked", !0),
      renderResult();
  }),
  $('.filter_tags .btn-tag input[type="checkbox"]').click(function () {
    var e = $(this).val();
    $(this).is(":checked")
      ? filterVal.tags.push(e)
      : removeArray(filterVal.tags, e),
      renderResult();
  }),
  ...
  $(function () {
    $("#modal_filter.modal").modal({
      onOpenStart: function () {
        var e = $("#filter_sidebar > aside");
        e.detach(), $("#filter_mobile").append(e);
      },
      onCloseEnd: function () {
        var e = $("#filter_mobile > aside");
        e.detach(), $("#filter_sidebar").append(e);
      },
    });
  });
var toastHTML =
  '<span>Message Sent</span><button onclick="M.Toast.dismissAll()" class="btn-icon waves-effect toast-action"><i class="material-icons">close</i></button>';
$.validate({
  form: "#contact_form",
  onSuccess: function (e) {
    return M.toast({ html: toastHTML }), !1;
  },
}),
  $(document).ready(function () {
    $.validate({
      ...
      onSuccess: function (e) {
        return (
          M.toast({
            html: '<span>Message Sent</span><button onclick="M.Toast.dismissAll()" class="btn-icon waves-effect toast-action"><i class="material-icons">close</i></button>',
          }),
          !1
        );
      },
      ...
      $.validate({ form: "#register_form", modules: "security" });
  });
var darkMode = "false";
...
var $header = $("#header"),
  ...
  isOpenHamburger = !1;
function initMap() {
  var e = { lat: 44.933076, lng: 15.629058 },
    t = document.getElementById("map"),
    a = new google.maps.InfoWindow({
      content:
        '<div id="content" class="buble"><h6 class="title pb-2 px-3">Head Quarter</h6><div class="row ma-3"><div class="col-sm-6 pa-0"><p><i class="material-icons">phone</i> +98 765 432 10</p></div><div class="col-sm-6 pa-0"><p><i class="material-icons">email</i> hello@luxi.com</p></div><div class="col-sm-12 pa-0"><p><i class="material-icons">location_on</i> Lorem ipsum street Block C - Vestibullum Building</p></div></div></div>',
    });
  if (t) {
    var o,
      i = new google.maps.Map(t, { zoom: 10, center: e });
    (o = new google.maps.Marker({ position: e, map: i })).addListener(
      "click",
      function () {
        a.open(i, o);
      }
...
$(document).ready(function () {
  ...
  "true" === darkMode &&
    ...
    $(".dropdown-trigger").dropdown({ closeOnClick: !1, alignment: "left" }),
      ...
      onOpenStart: function (e) {
        for (
          var t = $(e)
              .parent()
              .siblings()
              .find(".droplist-trigger-hover-child"),
            a = 0;
          a < t.length;
          a++
        )
          M.Dropdown.getInstance(t[a]).close();
      },
    }),
      ...
      onOpenStart: function (e) {
        for (
          var t = $(e)
              .parent()
              .siblings()
              .find(".droplist-trigger-click-child"),
            a = 0;
          a < t.length;
          a++
        )
    ...
    $("#mobile_menu").click(function () {
      if (!(isOpen = !isOpen)) return $(".sidenav").sidenav("close"), !1;
  ...
  $(function () {
    $("#lang_menu li").click(function () {
      var e = $(this).children(),
        ...
        i = a[a.length - 1],
        n = e.data("lang");
      window.location = t.replace(o + "/" + i, n + "/" + i);
    }),
      $("#lang_select").on("change", function () {
        var e = $(this).val(),
          ...
          o = a[a.length - 2],
          i = a[a.length - 1];
        return e && (window.location = t.replace(o + "/" + i, e + "/" + i)), !1;
      });
  }),
  $(document).ready(function () {
    var e = $("#detail_carousel");
    e.slick({
      dots: !0,
      arrows: !1,
      slidesToShow: 1,
...
function mqAddClass(e) {
  $(e).each(function () {
    var e = $(this).data("class");
    $(this).addClass(e);
  });
}
function mqRemoveClass(e) {
  $(e).each(function () {
    var e = $(this).data("class");
    $(this).removeClass(e);
  });
...
var handler_smUp = {
  ...
  handler_xlUp = {
    ...
    unmatch: function () {
      mqRemoveClass(".mq-xl-up");
    },
  },
  handler_xsDown = {
    match: function () {
      mqAddClass(".mq-xs-down");
    },
    unmatch: function () {
      mqRemoveClass(".mq-xs-down");
    },
  },
  handler_smDown = {
    match: function () {
      mqAddClass(".mq-sm-down");
    },
    unmatch: function () {
      mqRemoveClass(".mq-sm-down");
    },
  },
  handler_mdDown = {
    match: function () {
      mqAddClass(".mq-md-down");
    },
    unmatch: function () {
      mqRemoveClass(".mq-md-down");
    },
  },
  handler_lgDown = {
    match: function () {
      mqAddClass(".mq-lg-down");
    },
    unmatch: function () {
      mqRemoveClass(".mq-lg-down");
    },
  };
enquire
  ...
  $(function () {
    var e = $("#course_carousel");
    if ("rtl" === $("html").attr("dir")) {
      var t = Math.floor(e.data("length") - 2);
      setTimeout(function () {
        e.slick("slickGoTo", t);
      }, 100);
    }
    ...
    e.on("afterChange", function (e, t) {
      t.currentSlide >= 1 ? a.addClass("faded") : a.removeClass("faded");
    });
  }),
  $(function () {
...
$(function () {
  $("#slidemenu").sidenav({
    ...
    draggable: !1,
    onOpenStart: function () {
      (isOpenSide = !0), $(".btn-float-opt").addClass("active");
    },
    onCloseStart: function () {
      (isOpenSide = !1), $(".btn-float-opt").removeClass("active");
    },
  }),
    $(".opt-wrap .tabs").tabs({ swipeable: !1 }),
  ...
  var e = document.getElementsByClassName("img-2d3d");
  $("#image_switcher_side").change(function () {
    if ($(this).is(":checked"))
      for (var t = 0; t < e.length; t++)
        e[t].setAttribute("src", e[t].getAttribute("data-3d"));
    else
      for (t = 0; t < e.length; t++)
        e[t].setAttribute("src", e[t].getAttribute("data-2d"));
  }),
